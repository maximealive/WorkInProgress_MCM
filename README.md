...
## Getting Started
### Installations
1) WSL - Windows Subsystem for Linux  -> https://learn.microsoft.com/en-us/windows/wsl/install
2) SUMO -> https://sumo.dlr.de/docs/Installing/index.html
3) Docker + Vanetza-NAP -> file README.MD in vanetza-nap repository
